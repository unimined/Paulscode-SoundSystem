...
public class CommandObject {
	...
	/**
	 * Global identifier for the command to preload a sound file.
	 */
	...
	/**
	 * Global identifier for the command to tell a source whether to loop.
	 */
	...
	/**
	 * Global identifier for the command to set a source's fade distance or roll-off
	 * factor.
	 */
	...
	/**
	 * Global identifier for the command to set a source as permanent or temporary.
	 */
	...
	/**
	 * Global identifier for the command to move the listener.
	 */
