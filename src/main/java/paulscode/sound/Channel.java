 ...
 * ones.  For consistent naming conventions, each subclass should have the
 * name prefix "Channel".
 */
@SuppressWarnings({"UNUSED", "unused", "UnusedReturnValue"})
public class Channel {
	 ...
	 * values for this variable can be found in the
	...
	/**
	 * Cumulative counter of the buffers played then dequeued.
	 */
	public int buffersUnqueued = 0;

	/**
	 * Constructor:  Takes channelType identifier as a parameter.  Possible values
	...
	/**
	 * Plays the next queued byte[] buffer.  This method is run from the separate
	...
	public String getClassName() {
		...
		if (libTitle == null || "No Sound".equals(libTitle)) return "Channel";
		else return "Channel" + libTitle;
	}
